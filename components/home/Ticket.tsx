...
export default function Ticket() {
  return (
    <div className="w-full overflow-x-hidden">
      <div className="w-full h-[100vh] py-10 grid grid-cols-2 justify-between items-center px-10 gap-12">
        <div className="flex-1 h-full flex flex-col justify-center gap-12">
          <Typo className="text-primary text-6xl">GEM Main Galleries</Typo>
          <Typo font="p" direction="left" className="text-primary/60 text-sm">
            ...
            Galleries. <br /> Within the twelve meticulously curated exhibition
            halls of the Main Galleries, explore Egypt’s rich history, spanning
            from prehistoric times to the Roman era. Delve into the lives,
            spirituality, and burial practices of the Egyptian people as you
            experience millennia of their extraordinary civilisation. <br /> You
            can choose to embark on this journey at your own pace or through a
            90-minute guided tour.
          </Typo>
          <Button>BOOK YOUR TICKET</Button>
        </div>
        <div className="w-full aspect-square relative scale-x-[-1] ml-52">
          <Div
            direction="left"
          ...
          >
            <img
              src="/t1.jpg"
              alt=""
              className="w-full aspect-square object-cover shape absolute top-0 left-20 z-10"
            />
          </Div>
        </div>
      </div>
      <div className="w-full h-[100vh] py-10 grid grid-cols-2 justify-between items-center px-10 gap-12">
        <div className="w-full aspect-square relative -ml-52">
          <Div
            direction="left"
            value={animationValue}
            duration={1}
        ...
        <div className="flex-1 h-full flex flex-col justify-center gap-12">
          <Typo className="text-primary text-6xl">GEM Children Museum</Typo>
          <Typo font="p" direction="right" className="text-primary/60 text-sm">
